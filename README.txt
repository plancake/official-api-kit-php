*** PLANCAKE PHP API KIT *** 

You may be interested in this library if you want to develop a client application written in PHP that will use your Plancake data stored in the Cloud.
